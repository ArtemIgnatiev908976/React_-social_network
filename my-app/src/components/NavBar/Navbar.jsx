...
const Navbar = () =>{
  ...
  return  <nav className={s.nav}>
    ...
    <div className={s.item}><NavLink to='/profile'>News</NavLink></div>
    <div className={s.item}><NavLink to='/profile'>Music</NavLink></div>
    <div className={s.item}><NavLink to='/profile'>Settings</NavLink></div>
  </nav>
}
